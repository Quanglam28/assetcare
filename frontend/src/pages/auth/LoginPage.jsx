  ...
  return (
    <div>
      <div className="mb-6 text-center">
        <h3 className="text-xl font-bold text-slate-900">Đăng Nhập Hệ Thống</h3>
      ...
      {redirectParam && (
        <div className="mb-4 p-2.5 bg-brand-50 border border-brand-200 rounded-xl text-xs text-brand-800 flex items-center gap-2">
          ...
          <span>Bạn đang mở thiết bị từ mã QR. Sau khi đăng nhập, hệ thống sẽ tự động đưa bạn về đúng thiết bị.</span>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-1">
            ...
            <span className="text-[11px] text-brand-600 hover:underline cursor-pointer">Quên mật khẩu?</span>
          </div>
          <div className="relative rounded-lg shadow-sm">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400">
